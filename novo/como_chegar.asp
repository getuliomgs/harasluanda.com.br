            ...
            <tr>
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><img src="images/tit_como_chegar.gif" width="320" height="41"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td><p class="corpo_branco_pq">&Eacute; muito f&aacute;cil chegar ao Haras Luanda. Partindo de Salvador, pela BR 324,   virar &agrave; direita logo ap&oacute;s o posto da policia rodoviaria, sentido Sim&otilde;es Filho.   Logo ap&oacute;s a entrada de Pojuca, 22 km, virar &agrave; esquerda. </p>
                              <p class="corpo_branco_pq">No sentido contr&aacute;rio, a entrada do Haras situa-se a 9 km da cidade de   Ara&ccedil;as.</p>
                              <p align="center" class="corpo_branco_pq"><a href="images/comochegar_gr.jpg" rel="lightbox" title="Como chegar"><img src="images/comochegar.jpg" width="400" height="221" border="0"></a></p>
                              <p align="center" class="corpo_branco_pq">&nbsp;</p></td>
                            <td>&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
