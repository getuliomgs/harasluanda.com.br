                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td valign="top" bgcolor="#E1E1E1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td class="corpo_ver">Visualizar Arquivos </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td><p class="corpo_lar"><strong>*Clique no arquivo para baixar</strong></p>                            </td>
                            <td>&nbsp;</td>
                          </tr>
...
%>
                              ...
                              <table width="84%" height="76" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td valign="top"><p class="corpo"><strong>Arquivo:</strong></p>                                </td>
                                <td height="20" valign="top"><a href="uploads/<%=ArquivoNome%>" target="_blank" class="corpo"><%=ArquivoNome%></a></td>
                                <td>&nbsp;</td>
                              </tr>
                                <tr>
                                  <td><img src="../images/shim.gif" width="1" height="5"></td>
                                ...
                                <td bgcolor="#FFFFFF"><img src="../images/shim.gif" width="400" height="1"></td>
